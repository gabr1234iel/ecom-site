            ...
            <Container style={container}>
                <Section style={message}>
                    ...
                    <Text style={global.text}>
                        We're preparing everything for delivery, you will receive a notification once your package have been shipped. Delivery usually takes 2 business days.
                    </Text>
                    <Text style={{...global.text, marginTop: 24}}>
                        If you have any questions regarding your order, please feel free to reach out with your order number and we're here to help.
                    </Text>
                </Section>
                <Hr style={global.hr} />
