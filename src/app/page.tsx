    ...
    <div className="bg-slate-50">
      ...
      <section>
          <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3
            sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 md:pb-52">
            <div className="col-span-2 px-6 lg:px-6 lg:pt-4">
              ...
              flex flex-col items-center lg:items-start">
                ...
                <h1 className="relative w-fit tracking-light text-balance
                mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">Your image on a <span className="bg-green-600 px-2 text-white">Custom</span>{` `}Phone Case</h1>
